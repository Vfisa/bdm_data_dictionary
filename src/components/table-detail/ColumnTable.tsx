      ...
      <table className="w-full text-xs">
        <thead className="sticky top-0 bg-[var(--card)] z-10">
          <tr className="border-b border-[var(--border)]">
            <th className="text-left py-1.5 px-2 font-medium text-[var(--muted-foreground)]">
              Column
            </th>
            <th className="text-left py-1.5 px-2 font-medium text-[var(--muted-foreground)]">
              Type
            </th>
            <th className="text-center py-1.5 px-1 font-medium text-[var(--muted-foreground)]" title="Nullable">
              Null
            </th>
          </tr>
        </thead>
              ...
              >
                <td className="py-1.5 px-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className={`font-mono text-[11px] ${isPK ? 'font-semibold text-[var(--foreground)]' : 'text-[var(--foreground)]'}`}>
                      {col.name}
                    </span>
                  </div>
                  {col.description && (
