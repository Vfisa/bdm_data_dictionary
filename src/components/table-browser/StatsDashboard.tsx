...
export function StatsDashboard({ metadata }: StatsDashboardProps) {
  ...
  return (
    <div className="flex items-stretch gap-2 overflow-x-auto pb-1">
      {cards.map((card) => (
        <div
          key={card.label}
          className="flex items-center gap-2.5 px-3 py-2 rounded-lg border border-[var(--border)] bg-[var(--card)] min-w-0 shrink-0"
        >
